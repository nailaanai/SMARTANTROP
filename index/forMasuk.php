...
$namaAnak= $_POST["fname"];
$namaOrtu = $_POST["ortun"];
$nik = $_POST["nikor"];
$sql = "insert into masukortu values ('$namaAnak','$namaOrtu','$nik','NULL')";
    ...
    <div class="col-md-8 col-md-offset-3">
        <form id="msform" method="post">
            ...
            <fieldset>
                ...
                <label style="text-align:left" for="nikor">NIK Orangtua/Wali</label>
                <input type="text" name="nikor" required />

                <h3 class="fs-subtitle">Belum punya akun? <a href="form.php">Daftar sekarang!</a></h3>
            ...
            <!-- <fieldset>
                ...
                <input type="text" name="ortun" placeholder="Nama Orangtua"/>
                <input type="text" name="nik" placeholder="NIK"/>
                <input type="tel" name="no" placeholder="Nomor Telepon"/>
                ...
                <select name="provinsi" id="provinsi">
                    ...
                    <option value="provinsi2">Jawa Timur</option>
